...
# lis_name_scenes = ['scene0085_00'] # neuris 0085_00 [0.038 0.047 0.802 0.732 0.765]
...
if __name__ == '__main__':
    ...
    parser.add_argument('--dir_dataset', type=str, default='./dataset/indoor')
    parser.add_argument('--dir_results_baseline', type=str, default='./exps/evaluation')
    parser.add_argument('--path_mesh_pred', type=str, default='./exps/evaluation')
    parser.add_argument('--scene_name', type=str, default='scene0085_00')
    # parser.add_argument('--log_path', type=str, default='./log')
    args = parser.parse_args()
    
    lis_name_scenes = []
    lis_name_scenes.append(args.scene_name)
    ...
    if args.mode == 'eval_3D_mesh_metrics':
        ...
        dir_results_baseline = args.dir_results_baseline
        metrics_eval_all = []
        for scene_name in lis_name_scenes:
            logging.info(f'\n\nProcess: {scene_name}')

            # path_mesh_pred = f'{dir_results_baseline}/{name_baseline}/{scene_name}.ply'
            path_mesh_pred = args.path_mesh_pred
