...
class Runner:
    ...
    def load_pretrained_model(self):
        ...
        msg = (f"ckpt: {self.base_exp_dir}/checkpoints/{latest_model_name}")
        eval_log(msg)
    ...
    def train_neus(self):
        ...
        for iter_i in tqdm(range(res_step)):  
            ...
            input_model, logs_input = self.get_model_input(image_perm, iter_i) # input_model.pixels_x pixels_y pixels_uv pixels_vu torch.Size([512]) 这些pixels是啥意思
            ...
            patchmatch_out, logs_patchmatch = self.patch_match(input_model, render_out) # 是啥作用 计算Normalized Cross Correlation 用于衡量 visual consistency
